...
description: >
  ...
  （2）用户要求理解某类论文的谋篇布局规律；
  （3）用户需要写作指导 | 
un.py prescribe | scripts/update_prescription.py | 
eferences/chapter-writing.md |
| 自我进化 | 
un.py model self-assess | scripts/update_model.py | — |
| 写作指导——生成大纲、章节规划、论证策略建议；
...
| 自我进化 | `run.py model self-assess` | `scripts/update_model.py` | — |
